# Migration `20200528161958`

This migration has been generated by loan-petit at 5/28/2020, 4:19:58 PM.
...
"address" text   ,"email" text  NOT NULL ,"firstName" text  NOT NULL ,"id" SERIAL,"lastName" text  NOT NULL ,"minScheduleNotice" integer  NOT NULL DEFAULT 0,"password" text  NOT NULL ,"username" text  NOT NULL ,"websiteUrl" text   ,
    PRIMARY KEY ("id"))
